...
public class AnimalFarm {
	...
	void animals() {
		...
		*/			 
		...
		while (true){
			String animal = JOptionPane.showInputDialog("Choose a farm animal !");
			...
			String willrepeat = JOptionPane.showInputDialog("Would you like to choose another animal?");
			if (willrepeat.equals("no")) {
				break;
			}
		}
